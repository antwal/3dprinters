...
#define STRING_CONFIG_H_AUTHOR "(Prusa I3 MK2 Clone)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 48.74
  #define DEFAULT_bedKi 3.46
  #define DEFAULT_bedKd 457.82
#endif // PIDTEMPBED
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -20, -42, 0 }
